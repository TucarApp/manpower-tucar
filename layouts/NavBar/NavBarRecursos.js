          ...
          <div className="flex items-center justify-between h-16">
              ...
              <div className="hidden lg:inline">
                <div className="flex justify-between items-center">
                  <div className="ml-10 flex items-baseline space-x-4 ">
                      ...
                      <div className="flex items-start">
                        <a className="hover:cursor-pointer flex">
                          <span
                            className={
                              !socios
                                ? "flex items-start text-[#ffffff] opacity-80 ease-in-out duration-200 mr-[3px]"
                                : "flex items-start text-[#ffffff]  opacity-100 ease-in-out duration-200 mr-[3px]"
                            }
                          >
                            Se socio
                          </span>
                          {socios ? (
                            <ChevronUpIcon width="12px" color="#ffffff" />
                          ) : (
                            <ChevronDownIcon width="12px" color="#ffffff" />
                          )}
                        </a>
                      </div>
                      {socios && (
                    ...
                    >
                      <div className="flex items-start">
                        <a className="hover:cursor-pointer  text-[#ffffff] flex">
                          <span
                            className={
                              !recursos
                                ? "mr-[3px] text-[#ffffff] opacity-80 duration-200"
                                : "mr-[3px] text-[#ffffff] opacity-100 duration-200"
                            }
                          >
                            Recursos
                          </span>
            ...
            <div className="flex items-center md:hidden mr-3">
              ...
              <button
                ...
                type="button"
                className=" inline-flex items-center justify-center p-2  rounded-md text-[#ffffff] hover:text-[#ffffff] "
                        ...
                        <div className="py-2 ">
                          <div className="mx-5">
                            <ul
                              ...
                              onClick={() => setIsOpen(false)}
                            >
                              {/* <a href={`${url}/precios`} rel="noreferrer">
                                <li className="py-1">Precios</li>
                              </a> */}
                              <Link href="/como-funciona">
                        ...
                        <div className="py-2 ">
                          <div className="mx-5">
                            <ul className="list-disc font-Poppins font-light text-[14px]">
                              ...
                              {/* <a href={`${url}/recursos/preguntas-frecuentes`}>
